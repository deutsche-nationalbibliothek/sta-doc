...
export default function GndFields({ fields }: GndFieldsProps) {
  const filterFields = (obj: Fields) => {
    return Object.fromEntries(
      Object.entries(obj).filter(([key,field]) => field.codings['PICA+'].length !== 0)
    ) as Fields;
  };
  ...
  return (
    <>
      ...
      />
      <GndFieldsTable fields={filteredFields} locale={locale} singleColumn={'PICA'} />
    </>
  );
}
