...
async function recursiveRenderEntity(lookup_en, lookup_de, codings, id) {
  ...
  await Promise.all(Object.keys(entity.claims).map(async (key) => {
    ...
    if (key === 'P4') { // integrate coding from codings const
      ...
      obj['statements'][lookup_en[key]]['format'] = codings[id]['coding']['format']
    }
    ...
    await Promise.all(entity.claims[key].map(async (occurrence,index) => {
      if (occurrence.mainsnak.snaktype === 'value' && occurrence['mainsnak']['datavalue']['value']['id'] !== undefined) {
        obj['statements'][lookup_en[key]]['occurrences'][index] = {'id':occurrence['mainsnak']['datavalue']['value']['id'],'label':lookup_de[occurrence['mainsnak']['datavalue']['value']['id']]}
      } else if (occurrence['mainsnak']['snaktype'] === 'value' && occurrence['mainsnak']['datavalue']['value'] !== undefined) {
        obj['statements'][lookup_en[key]]['occurrences'][index] = {'value':occurrence['mainsnak']['datavalue']['value']}
      } else {
      ...
      if (key === 'P15') { // integrate coding in subfields (P15) object
        ...
        obj['statements'][lookup_en[key]]['occurrences'][index]['coding'] = codings[occurrence_id]['coding']
      }
      if (key === 'P11' || key === 'P396' || key === 'P411') { // integrate example (P11) OR embedded item (P396) OR embedded property (P411)
        let occurrence_id = occurrence['mainsnak']['datavalue']['value']['id']
        // obj['statements'][lookup_en[key]]['occurrences'][index]['statements'] = examples[occurrence_id]['statements']
        obj['statements'][lookup_en[key]]['occurrences'][index] = await recursiveRenderEntity(lookup_en, lookup_de, codings, occurrence_id)
      }
      // fourth level
      if (occurrence['qualifiers'] !== undefined) {
        ...
        await Promise.all(Object.keys(occurrence['qualifiers']).map(async (quali_key,quali_index) => {
          ...
          if (codings[quali_key]) {
            obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[quali_key]]['coding'] = codings[quali_key]['coding']
          }
          // fifth level
            ...
            if(occurrences2['datavalue'] !== undefined) {
              ...
              if (occurrences2_id) {
                ...
                if(codings[occurrences2_id]) {
                  obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[quali_key]]['occurrences'][index2]['coding'] = codings[occurrences2_id]['coding']
                }
                if (quali_key === 'P11' || quali_key === 'P396' || quali_key === 'P411') { // integrate example (P11) OR embedded item (P396) OR embedded property (P411)
                  // obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[quali_key]]['occurrences'][index2]['statements'] = items[occurrences2_id]['statements']
                  obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[quali_key]]['occurrences'][index2] = await recursiveRenderEntity(lookup_en, lookup_de, codings, occurrences2_id)
                }
              } else {
    ...
    claim.map((occ,index) => {
      ...
      if (occ['qualifiers']) {
        ...
        for (const [key4, qualifier] of Object.entries(occ.qualifiers)) {
          ...
          obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[key4]]['occurrences'] = []
          // insert codings if possible (OBJ)
          if (codings[key4]) {
          ...
          qualifier.map((quali_value,quali_index) => {
            obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[key4]]['occurrences'][quali_index] = {}
            if (quali_value['datatype'] === 'string') {
              obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[key4]]['occurrences'][quali_index]['value'] = quali_value['datavalue']['value']
            }
            ...
            if (key4 === 'P11') {
              obj['statements'][lookup_en[key]]['occurrences'][index]['qualifiers'][lookup_en[key4]]['occurrences'][quali_index]['statements'] = examples[quali_value['datavalue']['value']['id']]['statements']
            }
          })
        }
      }
