...
export const ENTRIES = `
  ...
  SELECT ?element ?eId ?elementLabel ?assignmentId ?assignmentLabel WHERE { # ?coding ?codingTypeLabel ?definition ?subfields ?subfieldsLabel
    { ?element prop:P2 item:Q264 . } #Element of: RDA-Eigenschaft
    UNION
    { ?element prop:P2 item:Q3113 . } #Element of: STA documentation
    UNION
    { ?element prop:P2 item:Q3095 . } #Element of: STA documentation: rules
    UNION
    { ?element prop:P2 item:Q2 . } #Element of: GND-Field
    UNION
    { ?element prop:P2 item:Q3 . } #Element of: GND-Subfield
    UNION
    { ?element prop:P2 item:Q14 . } #Element of: STA documentation: example
    UNION
    { ?element prop:P2 item:Q267 . } #Element of: RDA-Example
    UNION
    { ?element prop:P2 item:Q7 . } #Element of: STA documentation: class
    UNION
    { ?element prop:P2 item:Q296 . } #Element of: schema
    UNION
    { ?element prop:P110 item:Q15 . } #Schema: datamodel documentation
    UNION
    { ?element prop:P110 item:Q1 . } #Schema: Gnd data model
    UNION
    { ?element prop:P110 item:Q263 . } #Schema: RDA-documentation
    OPTIONAL
