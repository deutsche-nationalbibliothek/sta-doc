...
export const EntityPreviewContent: React.FC<EntityPreviewContentProps> = ({entity}) => {
  const statements = [...entity.statements.header, ...entity.statements.table, ...entity.statements.text, ]
